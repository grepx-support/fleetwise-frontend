describe('Contractor Claim CRUD E2E Tests', () => {
  beforeEach(() => {
    // Login as admin (has access to all contractor operations)
    cy.login('admin');
  });
  ...
  describe('READ - Contractor Claims List', () => {
    it('should display the contractor claims list', () => {
      // Navigate to the contractor billing page
      cy.visit('/billing/contractor-billing');

      // Wait for initial data to load
      cy.wait(3000);

      // Ensure the page title is visible
      cy.contains('h1', 'Contractor Payment Management').should('be.visible');
      ...
      // Verify that contractor filter chips are visible
      cy.contains('Filter by Contractor').should('be.visible');
    });
  });

  describe('GENERATE - Create Contractor Bill', () => {
    it('should generate a new contractor bill successfully', () => {
      // Navigate to the contractor billing page
      cy.visit('/billing/contractor-billing');
      ...
      cy.wait('@generateContractorBill', { timeout: 30000 });
  ...
  describe('DOWNLOAD - Contractor Bill PDF', () => {
    it('should download a contractor bill PDF successfully', () => {
      // Navigate to the contractor billing page
      cy.visit('/billing/contractor-billing');
      ...
      // Wait for API call and verify success
      cy.wait('@downloadContractorBill', { timeout: 30000 });
